...
/**
 * code from: http://bylijinnan.iteye.com/blog/1606892
 * 编程之美-24点游戏
 * 24点游戏：任取1－9之间的4个数字，用＋－＊／（）连结成算式，使得式子的计算结果为24。 http://weibo.com/1915548291/z6DYGpfFA
    ...
    public static void main(String[] args) throws Exception {  
        int k=0;  
            while(k<100){    //测试100次  
                ...
                //方法1  
                boolean ok=PointGame24.compute(number,result,CardsNumber);  
                if(ok){  
                    System.out.println("1. "+result[0]);  
                }  
                //方法2  
                boolean ok2=PointGame24.compute(source);  
